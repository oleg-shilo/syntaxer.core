...
namespace RoslynIntellisense
{
    public static class Formatter
    {
        ...
        // static Workspace dummyWorkspace;
        ...
        static string FormatCS(string code, bool normaliseLines)
        {
            ...
            var options = DummyWorkspace.Options
                .WithChangedOption(FormattingOptions.UseTabs, LanguageNames.CSharp, false)
                .WithChangedOption(FormattingOptions.TabSize, LanguageNames.CSharp, 4)
                // .WithChangedOption(FormattingOptions.IndentationSize, LanguageNames.CSharp, 7)
                ;

            SyntaxNode root = msFormatter.Format(tree.GetRoot(), DummyWorkspace, options);
